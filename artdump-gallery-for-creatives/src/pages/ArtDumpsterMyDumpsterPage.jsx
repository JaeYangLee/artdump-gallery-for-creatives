...
function ArtDumpsterMyDumpsterPage() {
  return (
    <>
      <div className="max-w-screen min-h-screen pt-[56px] font-barlow">
        ...
        <div className="flex flex-col flex-wrap items-center justify-center md:flex-row md:justify-center lg:justify-center lg:flex-row xl:justify-center">
