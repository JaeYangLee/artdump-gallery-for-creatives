      ...
      <div className="w-screen min-h-screen">
        <div className="pt-[56px] font-barlow text-[#372F3D]">
          <header className="p-2">
            <h1 className="text-3xl font-bold text-shadow-md">
              Add an artwork!
            </h1>
          </header>
          <div className="p-2">
            {/* Upload Section */}
            <div className="flex flex-col md:flex-row md:items-start items-center  p-2 max-w-screen min-h-screen bg-[#F8FAFC]">
