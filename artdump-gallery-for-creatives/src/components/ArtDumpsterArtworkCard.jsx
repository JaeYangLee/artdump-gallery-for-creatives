...
function ArtDumpsterArtworkCard() {
  ...
  return (
    <>
      <div
        className="z-30 p-2 transition duration-100 ease-in-out active:scale-90"
        onClick={() => setArtworkDisplayOpen(true)}
      >
        <div className=" group pb-2 flex flex-col items-center justify-end w-[288px] md:w-[328px] h-[300px] md:h-[320px] lg:h-[340px] lg:w-[308px] xl:w-[408px] xl:h-[380px] bg-[#F8FAFC] shadow-xl shadow-black/30 text-[#372F3D] hover:text-[#F8FAFC]">
