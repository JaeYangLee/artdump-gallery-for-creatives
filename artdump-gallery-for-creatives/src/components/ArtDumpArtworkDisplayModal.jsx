...
function ArtDumpArtworkDisplayModal({
  ...
  return (
    <>
      ...
      >
        <div className="md:p-2 md:pt-0 md:w-screen md:min-h-screen">
          <div
          ...
          >
            ...
            <div className="flex flex-col flex-wrap md:relative md:flex-row">
              <div className="md:relative flex flex-col justify-center item-center w-full md:w-[70%] lg:w-[70%] lg:h-[554px] md:h-[554px] h-[309px] bg-[#161618]">
                <img
              ...
              <div className="md:w-[30%] lg:w-[30%] md:h-[554px] lg:h-[554px]">
                <div className="flex flex-col items-center justify-center p-4 font-barlow font-light text-[#372F3D]/70 italic">
                  <section className="md:h-[54vh] p-2 pb-0 border rounded-lg border-black/30 placeholder:text-xs w-full h-[50px] text-xs">
                    Artwork description...
                  </section>
                </div>
                ...
                <div className="flex flex-col items-start justify-center gap-2 p-4">
                  <div className="flex flex-row items-center justify-center gap-4">
                    ...
                    <p className="text-xs italic font-light">00/00/00</p>
                  </div>
                  <div className="flex flex-row items-center justify-center gap-4">
                    <p className="text-xs font-medium">• Medium:</p>
                    <p className="text-xs italic font-light">Traditional</p>
                  </div>
                  <div className="flex flex-row items-center justify-center gap-4">
                    <p className="text-xs font-medium">• Tools:</p>
                    <p className="text-xs italic font-light">Ink</p>
                  </div>
                  <div className="flex flex-row items-center justify-center gap-4">
                    <p className="text-xs font-medium">• Genre:</p>
                    <p className="text-xs italic font-light">Manga</p>
                  </div>
                </div>
              </div>
            </div>
